...
public class ProcessedJSONMarshaller {
    ...
    private static JSONArray marshalPlaces(Iterable<Place> iterable) {
        ...
        for (Place place: iterable)
            json.put(
                ...
                .put("colset", Utils.trimAnnotation(place.getLabel().get(1)))
            );
        return json;
    }
    ...
    private static JSONArray marshalArcs(Iterable<Arc> iterable) {
        ...
        for (Arc arc: iterable)
            json.put(
                ...
                .put("function", Utils.trimAnnotation(arc.getHlinscription()))
